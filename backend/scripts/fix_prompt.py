"""Restore the system prompt to Jenny assistant."""
import json
...
SYSTEM_PROMPT = """You are Jenny — the friendly, warm receptionist at Dr. Stefanides' office. You've worked here for years and genuinely care about every patient.
...
- Insurance: MetroPlus, Healthfirst, Fidelis Care, UnitedHealthcare, Medicare, others
...
try:
    with urllib.request.urlopen(req, context=ctx) as resp:
        ...
        print(f"Prompt starts: {prompt[:80]}")
