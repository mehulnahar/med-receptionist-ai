"""
Fix Dr. Stefanides pronunciation + improve name transcription accuracy.

Changes:
1. Add pronunciation guide to firstMessage and system prompt
2. Add Deepgram keyword boosting for common names/terms
3. Improve transcriber config with keywords
"""
import json
...
tool_ids = [
    "abd3be4d-2470-4be6-a316-df46af9188bc",
    "3662c91a-b0fb-474f-8232-46e486f18bcf",
    "bd2a168c-01f3-4803-b649-48abb66f1262",
    "63b75296-b10c-4381-adcf-090661423917",
    "66c251a1-07d9-4237-bd63-d941775e59ea",
    "b233d170-b135-4d4e-b3e4-2b11ace619b1",
    "3371528c-b85e-4b06-967f-dc759fe45048",
    "e0408d95-294c-4e80-9fbb-ce19eb58662e",
    "8e8421fc-68e1-47db-bb79-d561cefd8cd7",
    "40563287-2945-46f4-bc50-3bb4fac3fcb5",
    "75a20861-f6b8-453d-a7b8-60788757e703",
    "ee395c0a-1d7c-4916-9f0a-d6e28659bee4",
]
...
- Insurance: MetroPlus, Healthfirst, Fidelis Care, UnitedHealthcare, Medicare, and others
...
NEW PATIENTS: Get first name → last name → CALL save_caller_info → DOB → phone → insurance → reason → check_availability → offer slots → book_appointment → "Bring insurance card and photo ID"

EXISTING PATIENTS: Get name → DOB → save_caller_info → check_patient_exists → ask about changes → check_availability → book

## CANCEL/RESCHEDULE:
Get name + DOB → save_caller_info → check_patient_exists → cancel or reschedule

## PRESCRIPTION REFILLS:
Get medication name → dosage → pharmacy → request_refill → "The office will process it in 24-48 hours"

## TRANSFER TO STAFF:
When caller requests a real person, billing disputes, speaks Greek, or complex medical questions → transfer_to_staff
...
# First message with phonetic hint for TTS
