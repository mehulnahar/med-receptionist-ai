...
import uuid
from sqlalchemy import Column, Index, String, Text, DateTime, Boolean, Integer, ForeignKey, CheckConstraint, text
...
class Voicemail(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_voicemail_practice_status", "practice_id", "status"),
    )
